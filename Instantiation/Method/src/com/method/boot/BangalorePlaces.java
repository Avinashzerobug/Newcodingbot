...
public class BangalorePlaces {
    ...
    public String[]  otherCountryNameswhoVisit;
    

    public BangalorePlaces(String name,char type,String place,int  noOfPlace,boolean correctLocation,String[] placeNames,String[] placeLocation,String[] members,double[] price,long[] totalTouristVisited,String[] otherCountryNameswhoVisit)
    ...
    
    {
   	 ...
   	 this.otherCountryNameswhoVisit = otherCountryNameswhoVisit;	    
...
public void display()
{
   ...
   System.out.println("Place Names");
	 ...
	 System.out.println(System.lineSeparator());
	 System.out.println("Other Country Names who Visit");
	 System.out.println("*******************************");
	 
	 for (int i = 0; i < otherCountryNameswhoVisit.length; i++) 
	 {
		String play6 = this.otherCountryNameswhoVisit[i];
