...
public class Currency {
   ...
   public boolean equals(Object object)
   {
   	if(object instanceof Currency) {
   	 ...
   	 if(this.name.equals(currenacy.name)&&this.companyName.equals(currenacy.companyName)&&this.color.equals(currenacy.color)&&this.productionArea.equals(currenacy.productionArea))
   	 {
