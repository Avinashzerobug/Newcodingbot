...
public class WaterBottle {
	...
	public WaterBottle(String name, double price, String companyName, String color, boolean uVProtection,
			String ownerName, int companyStarted, String productionArea, double stockMarketPrice, boolean taxIncluded) {
		super();
		this.name = name;
		this.price = price;
	...
	public String toString() {
		return "WaterBottle [name=" + name + ", price=" + price + ", companyName=" + companyName + ", color=" + color
	...
	public boolean equals(Object obj)
	{
		if(obj instanceof WaterBottle)
		{
			...
			if(this.name.equals(water.name)&&this.ownerName.equals(water.ownerName)&&this.companyName.equals(water.companyName))
			{
			    System.out.println("these properties are  equal ");
				return true;
			}
