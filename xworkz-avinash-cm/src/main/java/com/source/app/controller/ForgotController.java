...
public class ForgotController {
	...
	public String verifyOtp(@RequestParam("otp") int otp, HttpSession session) {
		...
		if (myOtp == otp && otpObject != null) {
			try {
				...
				// LocalDateTime otpCreationTime = (LocalDateTime)
				// session.getAttribute("otpCreationTime");
	...
	public String changePassword(@RequestParam String userId, @RequestParam("newpassword") String password,
